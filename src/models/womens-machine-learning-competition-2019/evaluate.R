...
main <- function() {
  ...
  # opt <-
  #   list(
  #     submissionpath = 'data/processed/womens-machine-learning-competition-2019/Stage2/submissions/model02',
  #     outfile = 'data/processed/womens-machine-learning-competition-2019/Stage2/submissions/model02/SubmissionStage2.csv',
  #     ncaatourney = "data/raw/womens-machine-learning-competition-2019/Stage2WDataFiles/WNCAATourneyDetailedResults.csv",
  #     metricsfile = 'data/processed/womens-machine-learning-competition-2019/Stage2/submissions/model02/eval.json'
  #   )
  ...
  byyear <- game_results %>%
    group_by(Season) %>%
    summarise(LogLoss = MLmetrics::LogLoss(Pred, Result),
